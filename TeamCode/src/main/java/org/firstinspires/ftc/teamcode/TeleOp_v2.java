...
public class TeleOp_v2 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        boolean buttonOptionsPressed = false;
        ...
        while (opModeIsActive()) {
            ...
            if (gamepad1.dpad_left) {
                robot.setUpperClaw(0);
                robot.setLowerClaw(0);
                robot.setSliderPosition(1, 0.5);
                robot.setIntakePosition();
                robot.setSliderPosition(2, 0.2);
            }
            ...
            telemetry.addData("in scoring", isInScoringPosition);
            telemetry.update();
        }
    }
}